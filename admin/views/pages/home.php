                            ...
                            <div class="card-body">
                                <div class="rounded ui-bordered p-3 mb-3">
                                    ...
                                    <div class="media align-items-center mt-3">
                                        <img src="${context}/admin/assets/img/avatars/12-small.png"
                                ...
                                <div class="rounded ui-bordered p-3 mb-3">
                                    ...
                                    <div class="media align-items-center mt-3">
                                        <img src="${context}/admin/assets/img/avatars/11-small.png"
                                            class="d-block ui-w-30 rounded-circle" alt>
                                ...
                                <div class="rounded ui-bordered p-3">
                                    ...
                                    <div class="media align-items-center mt-3">
                                        <img src="${context}/admin/assets/img/avatars/10-small.png"
                                            class="d-block ui-w-30 rounded-circle" alt>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="media pb-1 mb-3">
                        <img src="${context}/admin/assets/img/avatars/9-small.png"
                    ...
                    <div class="media pb-1 mb-3">
                        <img src="${context}/admin/assets/img/avatars/8-small.png"
                            class="d-block ui-w-40 rounded-circle" alt>
                        <div class="media-body ml-3">
                    ...
                    <div class="media">
                        <img src="${context}/admin/assets/img/avatars/7-small.png"
                            class="d-block ui-w-40 rounded-circle" alt>
                        <div class="media-body ml-3">
                ...
                <div class="card-body">
                    <div class="pb-1 mb-3">
                        ...
                        <small class="text-muted">Created by
                            <a href="javascript:void(0)" class="text-dark">Mike Greene</a> &nbsp;·&nbsp; 1 day
                            ago</small>
                    </div>
                    <div class="pb-1 mb-3">
                        ...
                        <br>
                        <small class="text-muted">Created by
                            <a href="javascript:void(0)" class="text-dark">Leon Wilson</a> &nbsp;·&nbsp; 1 day
                            ago</small>
                    </div>
                    <div class="pb-1 mb-3">
                        ...
                        <br>
                        <small class="text-muted">Created by
                            <a href="javascript:void(0)" class="text-dark">Allie Rodriguez</a> &nbsp;·&nbsp; 1 day
                            ago</small>
                    </div>
                    <div class="pb-1 mb-3">
                        ...
                        <br>
                        <small class="text-muted">Created by
                            <a href="javascript:void(0)" class="text-dark"> Kenneth Frazier</a> &nbsp;·&nbsp; 1 day
                            ago</small>
                    </div>
                    <div>
                        <div class="badge badge-outline-danger float-right">Bug</div>
