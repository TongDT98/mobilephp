...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <form action="index.php?controller=loaisanpham&action=do_edit" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div id="pay-invoice">
                                            <div class="card-body">
                                                <div class="row form-group">
                                                    <div class="col-md-3">
                                                        <label class="control-label mb-1 text-required">Tên Loại sản
                                                            phẩm</label>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <input type="text" name="TenLoaiSanPham" id="TenLoaiSanPham"
                                                            value="<?= $item->TenLoaiSanPham ?>" class="form-control">
