                                        ...
                                        <div id="pay-invoice">
                                            <div class="card-body">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="Gia" id="Gia" value="<?= $item->Gia ?>"
                                                            class="form-control">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="MauSac" value="<?= $item->MauSac ?>"
                                                            id="MauSac" class="form-control">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" name="PhanLoaiId"
                                                            value="<?= $item->PhanLoaiId ?>" id="PhanLoaiId">
                                                            <option value="">--Chọn loại sản phẩm--</option>

                                                            <?php
                                                            foreach ($ddlLSP as $lsp) {   ?>

                                                            <option value="<?= $lsp->Id ?>"><?= $lsp->TenLoaiSanPham ?>
                                                            </option>
                                                            <?php } ?>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number" name="OrderNumber"
                                                            value="<?= $item->OrderNumber ?>" id="OrderNumber"
                                                            class="form-control">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <select class="form-control" value="<?= $item->NhaSanXuatId ?>"
                                                            name="NhaSanXuatId" id="NhaSanXuatId">
                                                            <option value="">--Chọn nhà sản xuất--</option>
                                                            <?php
                                                            foreach ($ddlNSX as $nsx) {   ?>

                                                            <option value="<?= $nsx->Id ?>"><?= $nsx->TenNhaSanXuat ?>
                                                            </option>
                                                            <?php } ?>
                                                            <select>
                                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="pay-invoice">
                                            <div class="card-body">
                                                <div class="row form-group">
                                                    <div class="col-md-12">
                                                        <textarea text='value="<?= $item->MoTa ?>"' name="MoTa"
                                                            id="MoTa" rows="4" class="form-control
                                                    ckeditor">
                                          </textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="pay-invoice">
                                            <div class="card-body">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="Camera" value="<?= $item->Camera ?>"
                                                            id="Camera" class="form-control">
                                                    </div>
                                                    <div class="col-md-2">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="HoTroTheNho"
                                                            value="<?= $item->HoTroTheNho ?>" id="HoTroTheNho">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="KetNoi" id="KetNoi"
                                                            value="<?= $item->KetNoi ?>" class="form-control">
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="HeDieuHanhId"
                                                            value="<?= $item->HeDieuHanhId ?>" id="HeDieuHanhId">
                                                            <?php
                                                            foreach ($ddlHDH as $hdh) {   ?>

                                                            <option value="<?= $hdh->Id ?>"><?= $hdh->TenHeDieuHanh ?>
                                                            </option>
                                                            <?php } ?>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control" value="<?= $item->ManHinhId ?>"
                                                            name="ManHinhId" id="ManHinhId">
                                                            <?php
                                                            foreach ($ddlMH as $mh) {   ?>

                                                            <option value="<?= $mh->Id ?>"><?= $mh->KichThuocManHinh ?>
                                                            </option>
                                                            <?php } ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="KichThuoc"
                                                            value="<?= $item->KichThuoc ?>" id="KichThuoc"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" value="<?= $item->TrongLuong ?>"
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" value="<?= $item->GiaiTriUngDung ?>"
                                                            name="GiaiTriUngDung" id="GiaiTriUngDung"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="ThongTinPin"
                                                            value="<?= $item->ThongTinPin ?>" id="ThongTinPin"
                                                            class="form-control">
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" value="<?= $item->CongNgheManHinh ?>"
                                                            name="CongNgheManHinh" id="CongNgheManHinh"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" value="<?= $item->TocDoCPU ?>"
                                                            name="TocDoCPU" id="TocDoCPU" class="form-control">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label class="control-label mb-1">Chip xử lý</label>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="text" value="<?= $item->ChipXuLy ?>"
                                                            name="ChipXuLy" id="ChipXuLy" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="DoPhanGiai"
                                                            value="<?= $item->DoPhanGiai ?>" id="DoPhanGiai"
                                                            class="form-control">
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="DoRong" value="<?= $item->DoRong ?>"
                                                            id="DoRong" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="number" value="<?= $item->BaoHanh ?>"
                                                            name="BaoHanh" id="BaoHanh" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
