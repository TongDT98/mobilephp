<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-3 mb-4">
        <div>Người dùng</div>
        <button data-toggle="modal" data-title="Thêm mới" data-target="#globalModalIframe"
            data-src="/mobilephp/admin/index.php?controller=sanpham&action=add" type="button"
            class="btn btn-dark btn-round d-block">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="text-center" style="width: 100px;">
                            <div class="btn-group btn-group-sm">
                                <button data-toggle="modal" data-title="Chi tiết hóa đơn"
                                    data-target="#globalModalIframe"
                                    data-src="index.php?controller=sanpham&action=index&Id=<?php echo $item->Id; ?>"
